...
import SuperControlEnhanced from '../components/fixtures/SuperControlEnhanced';
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              padding: '12px 24px',
              background: showEnhanced ? '#dc3545' : '#28a745',
              color: 'white',
              border: 'none',
              borderRadius: '8px',
              cursor: 'pointer',
          ...
          >
            <LucideIcon name={showEnhanced ? "EyeOff" : "Eye"} style={{ marginRight: '8px' }} />
            {showEnhanced ? 'Hide' : 'Show'} Enhanced SuperControl
          </button>
        </div>
      </div>
