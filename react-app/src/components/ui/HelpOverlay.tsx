          ...
          <div className={styles.tabContent}>
            ...
            <div className={styles.section}>
              ...
              <ul>
                ...
                <li><strong>red blink</strong> — record-armed save column; press a flashing red clip pad to save current DMX</li>
                <li><strong>orange-blink</strong> — active deck scene, playing ACT, or active group auto</li>
                <li><strong>red</strong> — Stop All or FULL ON active</li>
              </ul>
