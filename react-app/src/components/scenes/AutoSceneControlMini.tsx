...
export const AutoSceneControlMini: React.FC<AutoSceneControlMiniProps> = ({
  ...
  const autoSceneTooltip = 'Scene Auto does not save new scenes. It auto-loads the saved scenes in its queue on the selected beat interval and tempo source.';
  ...
  const renderContent = () => {
    ...
    return (
      <div className={styles.content} title={autoSceneTooltip}>
        <div className={styles.controls}>
          <div className={styles.info}>
            <div className={styles.bpmDisplay} title="Tempo currently driving Scene Auto.">
              {getCurrentBpm().toFixed(1)} BPM
            </div>
            <div className={styles.sceneCount} title="Number of saved scenes queued for automatic loading.">
        ...
        <div className={styles.tempoControls}>
          <select
            ...
            title="Choose the clock source that advances Scene Auto."
          >
          ...
          {autoSceneTempoSource === 'manual_bpm' && (
            <input
              ...
              title="Manual BPM used to advance Scene Auto."
            />
          )}
          ...
          {autoSceneTempoSource === 'tap_tempo' && (
            <button
              ...
              title="Tap repeatedly to set the Scene Auto tempo."
            >
        ...
        <div className={styles.directionSection}>
          <button
            ...
            title="Show scene order controls: forward, ping-pong, or random."
          >
          ...
          {showDirectionControls && (
            <div className={styles.directionControls}>
              <select
                ...
                title="Scene Auto order: forward, ping-pong, or random."
              >
        ...
        <div className={styles.sceneManagementSection}>
          <button
            ...
            title="Show the saved-scene queue used by Scene Auto. This does not save new scenes."
          >
            ...
            <div className={styles.sceneManagement}>
              <div className={styles.sceneActions}>
                <button
                  ...
                  title="Add every saved scene to the Scene Auto loading queue."
                >
                ...
                <button
                  ...
                  title="Clear the Scene Auto queue. This does not delete saved scenes."
                >
                  ...
                  {scenes.map((scene) => (
                    <div key={scene.name} className={styles.sceneItem}>
                      <button
                        ...
                        title={isSceneInAutoList(scene.name) ? 'Remove this saved scene from automatic loading.' : 'Add this saved scene to automatic loading.'}
                      >
                        <LucideIcon 
  ...
  const content = (
    <>
      <div className={styles.header}>
        <span className={styles.title} title={autoSceneTooltip}>Scene Auto</span>
