  ...
  const handleFactoryReset = async () => {
    ...
    try {
      ...
      useStoreUtils.setState({
        ...
        debugTools: { debugButton: true, midiMonitor: true, oscMonitor: true, dmxMonitor: true },
      ...
      setLocalDebugTools({ debugButton: true, midiMonitor: true, oscMonitor: true, dmxMonitor: true });
