...
export const UnifiedSettings: React.FC = () => {
  ...
  useEffect(() => {
    ...
    scheduleSave({ themeColors: previewThemeColors });
  }, [previewThemeColors, updateThemeColors, scheduleSave]);
  ...
  useEffect(() => {
    ...
    setServerSyncPending(true);
    scheduleSave({ themeColors: previewThemeColors });
  }, [previewUiSettings, updateUiSettings, scheduleSave, previewThemeColors]);
