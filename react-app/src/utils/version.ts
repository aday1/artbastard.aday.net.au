...
export const CURRENT_VERSION: VersionInfo = {
  ...
  releaseType: 'stable',
  features: [
    'Official hosted release (DMX512 nod: 5.1.2)',
    'Channel role icons on DMX strips, pinned sidebar, and DMX Tracker columns',
  ...
  changelog: [
    'v5.1.2: First official hosted release under dev/live lanes (GHCR + Linode)',
    'v5.1.2: Pinned sidebar notched faders; mobile defaults to Canvas DMX tab',
